        ...
        <div className="py-12 flex flex-col items-center justify-center min-h-[400px]">
          {status === 'idle' && (
            <div className="flex flex-col items-center w-full max-w-sm mx-auto animate-in fade-in zoom-in duration-500">
              ...
              <div className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-6 mb-6 backdrop-blur-md">
                <h3 className="text-slate-900 dark:text-white font-medium mb-2 flex items-center gap-2">
                  <Hash className="w-4 h-4 text-indigo-400" />
                  Match by Interests (Optional)
                </h3>
                <p className="text-xs text-slate-500 dark:text-white/50 mb-4 text-left">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {interests.map(tag => (
                    <span key={tag} className="bg-indigo-500/20 text-indigo-300 px-3 py-1 rounded-full text-xs flex items-center gap-1 border border-indigo-500/30">
                      {tag}
                      <button onClick={() => removeInterest(tag)} className="hover:text-slate-900 dark:hover:text-white transition-colors"><X className="w-3 h-3" /></button>
                    </span>
                  ))}
                </div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500 transition-colors disabled:opacity-50"
                />
              </div>
