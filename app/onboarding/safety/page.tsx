    ...
    <div className="container mx-auto px-6 py-10">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] items-start">
        <section className="card p-6">
          ...
          <h2 className="mt-4 text-3xl font-semibold text-white">Safety promise</h2>
          <p className="mt-3 text-sm text-white/50">We prioritize calm and respectful conversation.</p>

          <div className="mt-6 space-y-3">
            {rules.map((item) => {
              const Icon = item.icon;
              return (
                <div key={item.text} className="flex items-center gap-3 rounded-xl border border-white/5 bg-white/[0.03] px-4 py-3">
        ...
        <section className="glass p-6">
          <div className="card p-6">
            ...
            <p className="mt-2 text-sm text-white/50">You can update preferences any time in Settings.</p>
